...
function zoomGastos(obj) {
    ...
    tdizoomCheck.open(
        "dsProdutos", //Nome do Dataset
        "codGasto,Codigo,descrGasto,Descrição,unidadeDesc,Unidade,SALDO,Saldo", //Campos a serem exibidos
...
function zoomLote(obj) {
    ...
    tdizoom.open(
        ...
        "B8_LOTECTL,Lote", //Campos a serem exibidos
        "B8_LOTECTL", //Campos de retorno
        "Lote", //Titulo
        filters, //Filtros
        type, //Type (deve ser sempre o atributo name do campo)
        null, //likefield
...
function zoomTipoAtendimento(obj) {
   ...
   // FLUIGIP.TABLE.clearTable("itensTipoAtendimento")
    ...
    tdizoomCheck.open(
        ...
        "Descr,Descrição", //Campos a serem exibidos
        "codigo,Descr", //Campos de retorno
        "Selecione o tipo de procedimento", //Titulo
        filters, //Filtros
        type, //Type (deve ser sempre o atributo name do campo)
        null, //likefield
        null, //likevalue
...
function zoomTomador(obj) {
    ...
    tdizoom.open(
        ...
        "ZZA_FILIAL,Filial,CTT_NOME,Tomador,ZZA_CUSTO,Centro de Custo,ZZA_LOCAL,Local", //Campos a serem exibidos
        "ZZA_FILIAL,CTT_NOME,ZZA_CUSTO,ZZA_LOCAL", //Campos de retorno
        "Tomador", //Titulo
        filters, //Filtros
        type, //Type (deve ser sempre o atributo name do campo)
        null, //likefield
...
function setSelectedZoomItem(selectedItem) {
    ...
    if (name == "nacionalidade") {
        ...
        $("#tomador").val(selectedItem.CTT_NOME.trim());
