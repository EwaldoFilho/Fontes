...
function validateLiberacaoPassiente() {
    ...
    if (libPassiente == "remocaoTerceiros" || libPassiente == "remocaoTransferencia" ) {
...
function validarRecusaRemocao() {

    var recusaRemocao = $("#recusaRemocao").val();

    if (recusaRemocao == "SIM") {
        $("#recusaRemocaoAssintaura").show();
    } else {
        $("#recusaRemocaoAssintaura").hide();
    }
}
