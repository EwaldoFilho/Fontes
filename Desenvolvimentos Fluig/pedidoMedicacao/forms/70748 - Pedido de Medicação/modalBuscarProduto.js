                     ...
                     '<div class="row">'+
                        '<div class="form-group col-sm-12 ms-left">'+ 
                           '<div class="input-group col-sm-12">'+
                                 ...
                                 '<textarea class="form-control" rows="5" name="especificacaoTecnicaModal" id="especificacaoTecnicaModal" data-fluig-state-valid="0,4" data-fluig-write="0,4" required="required"></textarea>'+                  
                              '</div>'+
                        '</div>'+
                     '</div>'+
                     ''+
     ...
     // $("#valorOrcamentoModal").keyup(formatarInput);
      ...
      $("#especificacaoTecnicaModal").keyup(maskCharacters);
       ...
       $("#fluig-modal").find("button[data-search-modal]").on("click", function() {    
         ...
         if ($("#listaProdutos").val() != "" && isEdit == true) {
