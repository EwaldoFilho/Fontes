...
$(document).ready(function () {
    ...
    if (getAtividade() != INICIO & getAtividade() != 26) {
    	
    	//MEI
        invisibleBtnUpload("fnDas")
        invisibleBtnUpload("fnExtrato")
        invisibleBtnUpload("fnNfMEI")
        invisibleBtnUpload("fnCCMEI")
        invisibleBtnUpload("fnCs")
        invisibleBtnUpload("fnCNDF")
        invisibleBtnUpload("fnNfPJ")
        invisibleBtnUpload("fnDasComprovante")
        
        //outros PJ
        invisibleBtnUpload("fnCS")
        invisibleBtnUpload("fnNFPJ")
        invisibleBtnUpload("fnCND")
        invisibleBtnUpload("fnFP")
        invisibleBtnUpload("fnSFP")
        invisibleBtnUpload("fnINSS")
        invisibleBtnUpload("fnDasComprovantePJ")
