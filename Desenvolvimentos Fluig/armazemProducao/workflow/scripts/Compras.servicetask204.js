function servicetask204(attempt, message) {
	log.info("### Inicialização da Cotação no TOTVS Protheus - servicetask130 - INICIO ###");
	...
	for (var countProd = 0; countProd < cotacoes.length; countProd++) {
		log.info("INFO PROD::::"+JSON.stringify(cotacoes[countProd]));
	...
	log.info("INFO OBJBACK::::"+JSON.stringify(objBackEnd));
	 ...
	 log.info("### Finalização da Cotação no TOTVS Protheus - servicetask130 - FIM ###");
