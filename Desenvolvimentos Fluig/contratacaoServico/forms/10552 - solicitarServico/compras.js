...
function zoomProdutoModal(obj) {	
    ...
    tdizoom.open(
        "compras_buscar_servicos",
        "CODIGO,Código,DESCRICAO,Descrição,UNIDADE,Unidade,GRUPO,Grupo",
        "CODIGO,DESCRICAO",
