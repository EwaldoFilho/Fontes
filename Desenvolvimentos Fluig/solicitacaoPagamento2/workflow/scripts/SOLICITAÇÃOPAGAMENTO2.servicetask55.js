function servicetask55(attempt, message) {	
	...
	log.info("### Inclusão de pré nota - servicetask55 - INICIO ###");
		...
		var cCondPagto       = '"'+hAPI.getCardValue("001")+'"';
		var dDTemissao       = '"'+hAPI.getCardValue("dataFormatada")+'"';
		var cEspecie       = '"'+hAPI.getCardValue("NF")+'"';
		...
		try {
		 ...
		 log.info("### Finalização da integração Pré Nota TOTVS Protheus - servicetask55 - FIM ###");
}