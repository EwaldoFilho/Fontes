...
$("#tb_produtos").on("click", ".remover", function(e){
 ...
 $("#modalBuscarProduto").click(function () {
    var myModal = FLUIGC.modal({
       ...
       content: '<form name="formModal" onsubmit="return false;" style="background-image: url(http://portal.medmais.com:8007/portal/api/servlet/image/0101001/custom/abstrato-branco-3d.jpg);" onsubmit="return false;">'+
                     '<div>'+
                     '<div class="row">'+
                     ...
                     '<div class="row">'+
                        '<div class="form-group col-sm-12 ms-left"> '+
                              ...
                              '<div class="input-group col-sm-12">  '+
                                 ...
                                 '<input type="text" class="form-control" name="produtoModal" id="produtoModal" data-fluig-state-valid="0,4" data-fluig-write="0,4" required="required" readonly placeholder="Selecione o Produto Clicando na Lupa">'+
                        ...
                        '<div class="form-group col-sm-12 ms-left" style="display: flex !important;">'+ 
                           '<div class="input-group col-sm-6">'+  
                              ...
                              '<div class="input-group col-sm-6" style="margin-left: 1%;">'+
                                 '<label for="valorOrcamento">Valor Orçamento<strong class="required text-danger"></strong></label>'+
                     ...
                     '<div class="row">'+
                        '<div class="form-group col-sm-12 ms-left">'+ 
                           '<div class="input-group col-sm-12">'+
                                 ...
                                 '<textarea class="form-control" rows="5" onpaste="return false" name="especificacaoTecnicaModal" id="especificacaoTecnicaModal" data-fluig-state-valid="0,4" data-fluig-write="0,4" required="required"></textarea>'+                  
                              '</div>'+
                        '</div>'+
                     '</div>'+
                     ''+
                     '<div class="row">'+
                        '<div class="form-group col-sm-12 ms-left"> '+
                           '<div class="input-group col-sm-12">'+
                           '<label for="observacao">Observação<strong class="required text-danger"></strong></label>'+
                           '<textarea class="form-control" rows="5" onpaste="return false" name="observacaoModal" id="observacaoModal" data-fluig-state-valid="0,4" data-fluig-write="0,4" required="required"></textarea>'+
                              '</div>'+
                        '</div>'+
                     '</div>'+
                  '</div>'+
      ...
      var inputProduto = document.getElementById("produtoModal");
     ...
     // $("#valorOrcamentoModal").keyup(formatarInput);
      ...
      $("#especificacaoTecnicaModal").keyup(maskCharacters);
