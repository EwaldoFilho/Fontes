...
function openPA() {
	...
	var url2 =
	    ...
	    + '/portal/p/' 
	    + numEmpresa
	    + '/pageworkflowview?app_ecm_workflowview_detailsProcessInstanceID=' + numPA
	    + '&app_ecm_workflowview_taskUserId=' + usuarioLogado;
	
	window.open(url2, "Plano de ação", "toolbar=no,scrollbars=yes,resizable=yes,width=1024,height=768");
