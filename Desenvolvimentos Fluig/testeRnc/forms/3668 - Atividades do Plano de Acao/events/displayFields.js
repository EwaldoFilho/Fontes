function displayFields(form,customHTML){
	...
	form.setEnabled("dtPrazoAPA"		,false);
	form.setEnabled("nmComentarioPrazo"	,false);
	
	if(numActivity != INICIO){
		form.setEnabled("dsAtividade", false);
	}
	
	log.info("######## IF #######" + numActivity);	
	...
	if(numActivity == 12 ){
		form.setEnabled("dtPrazoAPA"		,true);
		form.setEnabled("nmComentarioPrazo"	,true);
	}
