function displayFields(form, customHTML) {
	...
	//if (state=="0") {
	//	form.setValue("tomador", usuarioDataSet.getValue(0, "CTT_NOME"));
	//	form.setValue("codigoCentroCusto", usuarioDataSet.getValue(0, "ZZA_CUSTO"));
	//	form.setValue("armazem", usuarioDataSet.getValue(0, "ZZA_LOCAL"));
	//	}
