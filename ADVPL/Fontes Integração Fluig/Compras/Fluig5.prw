...
/* ===============================================================================
WSDL Location    http://portal.medmais.com:8007/webdesk/ECMWorkflowEngineService?wsdl
Gerado em        09/16/21 16:33:31
...
User Function _JPFQMEM ; Return  // "dummy" function - Internal Use 
...
If !FindFunction("XMLCHILDEX")
	UserException("O Cùdigo-Fonte Client atual requer os executùveis do Protheus Build [7.00.191205P-20200220] ou superior. Atualize o Protheus ou gere o Cùdigo-Fonte novamente utilizando o Build atual.")
EndIf
Return Self
...
oXmlRet := SvcSoapCall(Self,cSoap,; 
	...
	"http://portal.medmais.com:8007/webdesk/ECMWorkflowEngineService")
...
cSoap += WSSoapValue("username", ::cusername, cusername , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("password", ::cpassword, cpassword , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("companyId", ::ncompanyId, 1, "int", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.,.F.) 
...
cSoap += '<q1:setAutomaticDecisionClassic xmlns:q1="http://portal.medmais.com:8007/webdesk/services/ECMw?wsdl">'
cSoap += WSSoapValue("username", ::cusername, cusername , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("password", ::cpassword, cpassword , "string", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("companyId", ::ncompanyId, ncompanyId , "int", .T. , .T. , 0 , NIL, .F.,.F.) 
cSoap += WSSoapValue("processInstanceId", ::nprocessInstanceId, nprocessInstanceId , "int", .T. , .T. , 0 , NIL, .F.,.F.) 
