...
Private nVlrTotBen	:= 0    //-Vlr.Registros 
...
cQuery  := "SELECT DISTINCT RA_LOCBNF, RA_FILIAL,RA_MAT,RA_CC "
...
cQuery  += " ORDER BY RA_LOCBNF,RA_FILIAL,RA_MAT,RA_CC "
...
If lNovoCalc
	...
	cSelect  += " RA_ENDEREC,RA_COMPLEM,RA_BAIRRO,RA_MUNICIP,RA_ESTADO,RA_CEP,RA_NUMENDE,RA_TELEFON, "
	cSelect  += " RA_NASC,RA_CIC,RA_RG,RA_RGORG,RA_MAE,RA_EMAIL,RA_ESTCIVI,RA_SEXO,RA_PAI,RA_RGUF,RA_PIS "
...
While QD03VB->(!Eof())
    ...
    If lNovoCalc
	    ...
	    cQuery  += " GROUP BY R0_FILIAL,R0_MAT,R0_CODIGO ,R0_TPVALE,R0_TPBEN,R0_VALCAL"
	    cQuery  += " ORDER BY R0_FILIAL,R0_MAT,R0_CODIGO,R0_TPVALE,R0_TPBEN,R0_VALCAL"
